...
<link  rel="stylesheet" type="text/css" href="<c:url value="/resource/css/notaccess.css" />" >
<script src="<c:url value="/resource/js/notaccess.js"  />" ></script>
<title>Your are not Authorised to Access</title>
</head>
<body>
<h1>403</h1>
